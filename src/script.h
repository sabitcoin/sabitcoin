...
#ifndef H_SABITCOIN_SCRIPT
#define H_SABITCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CSabitcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Sabitcoin always counted CHECKMULTISIGs
