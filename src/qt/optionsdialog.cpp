    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new SabitcoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->sabitcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Sabitcoin."), QMessageBox::Ok);
