...
unlocked to sign the Sabitcoin-Qt.app bundle.
...
allowing somebody to distribute a Sabitcoin-Qt.app or sabitcoin-qt-setup.exe with a valid
...
that the sabitcoin-qt.exe file inside the installer had not been tampered with.
