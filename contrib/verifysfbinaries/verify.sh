...
WORKINGDIR="/tmp/sabitcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/sabitcoin/Sabitcoin/sabitcoin-0.8.6/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/sabitcoin/Sabitcoin/"
VERSIONPREFIX="sabitcoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'sabitcoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[sabitcoin-]<version>-[rc[0-9]] (example: sabitcoin-0.7.1-rc1)"
   echo "wget output:"
